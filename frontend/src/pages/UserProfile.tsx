    ...
    <section>
      <div className="flex items-center justify-between mb-4">
        <h2 className="font-serif text-xl font-semibold text-ink-900 flex items-center gap-2">
          ...
          Reading Lists <span className="text-xs font-semibold px-1.5 py-0.5 rounded bg-ink-50 dark:bg-gray-700 text-ink-700 dark:text-gray-200 align-middle ml-2 tracking-wide">[{allLists.length}]</span>
        </h2>
        {isOwnProfile && (
          <button
    ...
    <div className="max-w-4xl mx-auto px-4 py-10 flex flex-col gap-10">
      ...
      {currently_reading.length > 0 && (
        <section>
          <SectionHeader
            ...
            title={<>Currently Reading <span className="text-xs font-semibold px-1.5 py-0.5 rounded bg-ink-50 dark:bg-gray-700 text-ink-700 dark:text-gray-200 align-middle ml-2 tracking-wide">[{currently_reading.length}]</span></>}
      ...
      {commentedBooks.length > 0 && (
        <section>
          <SectionHeader
            ...
            title={<>Comments <span className="text-xs font-semibold px-1.5 py-0.5 rounded bg-ink-50 dark:bg-gray-700 text-ink-700 dark:text-gray-200 align-middle ml-2 tracking-wide">[On {commentedBooks.length} {commentedBooks.length === 1 ? "book" : "books"}]</span></>}
      ...
      <section>
        <SectionHeader
          ...
          title={<>Books Uploaded <span className="text-xs font-semibold px-1.5 py-0.5 rounded bg-ink-50 dark:bg-gray-700 text-ink-700 dark:text-gray-200 align-middle ml-2 tracking-wide">[{books_uploaded.length}]</span></>}
        />
